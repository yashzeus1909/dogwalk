-- PawWalk Dog Walker Application - XAMPP MySQL Schema
-- Complete database structure with sample data for XAMPP environment

-- Create database for XAMPP
CREATE DATABASE IF NOT EXISTS dogWalk CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE dogWalk;
