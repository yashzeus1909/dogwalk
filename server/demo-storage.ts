  ...
  private walkers: Walker[] = [
    {
      ...
      distance: "0.5 miles",
      price: 25,
      description: "Experienced professional dog walker with 5+ years caring for dogs of all sizes. Specializes in pet sitting and overnight care.",
      availability: "Mon-Fri 9am-5pm",
      badges: ["Verified", "Insured", "Pet Sitting"],
    ...
    },
    {
      ...
      distance: "0.8 miles",
      price: 30,
      description: "Professional pet care specialist with behavioral training expertise. Offers grooming and overnight care services.",
      availability: "Daily 6am-8pm",
      badges: ["Verified", "Insured", "Background Checked", "Grooming", "Overnight"],
