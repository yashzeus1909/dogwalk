...
CREATE TABLE IF NOT EXISTS users (
    ...
    phone VARCHAR(20),
    address TEXT,
    role ENUM('customer', 'walker', 'admin') DEFAULT 'customer',
    ...
    description TEXT,
    availability TEXT,
    badges JSON, -- JSON array of badges
...
CREATE TABLE IF NOT EXISTS bookings (
    ...
    dog_size ENUM('Small', 'Medium', 'Large') NOT NULL,
...
INSERT INTO users (first_name, last_name, email, password, phone, address, role, profile_image_url, rating, review_count, distance, price_per_hour, description, availability, badges, services, background_check, insured, certified) VALUES
('Sarah', 'Johnson', 'sarah.johnson@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '(555) 123-4567', '123 Main St, City', 'walker', 'https://randomuser.me/api/portraits/women/1.jpg', 4.9, 127, '0.8 miles', 25.00, 'Experienced dog walker with 5+ years caring for dogs of all sizes. I love taking dogs on adventures and ensuring they get the exercise they need!', 'Available Mon-Fri 9AM-5PM', '["Certified", "Insured", "Pet First Aid"]', '["Dog Walking", "Pet Sitting"]', TRUE, TRUE, TRUE),
('Mike', 'Chen', 'mike.chen@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '(555) 234-5678', '456 Oak Ave, City', 'walker', 'https://randomuser.me/api/portraits/men/2.jpg', 4.8, 89, '1.2 miles', 22.00, 'Professional pet sitter and dog walker. Specializing in senior dogs and puppies. Background checked and fully insured.', 'Available 7 days a week', '["Background Checked", "Insured"]', '["Dog Walking", "Pet Sitting", "Grooming"]', TRUE, TRUE, FALSE),
...
INSERT INTO bookings (walker_id, customer_id, dog_name, dog_size, booking_date, booking_time, duration, phone, address, special_notes, total_price, status) VALUES
